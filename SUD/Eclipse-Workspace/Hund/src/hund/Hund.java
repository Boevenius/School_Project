...
/**
 * 
 * @class Hund speichert die Eigenschaften eines Hundes und stellt
 *        Hund-Funktionalit�t zur Verf�gung
 */
public class Hund {
	...
	/**
	 * 
	 * @param name Setzt den Namen des Hundes auf den übergebenen Parameter falls
	 *             der Name aus mehr als zwei Sonderzeichen besteht Name des Hunds
	 *             besteht nur aus Buchstaben und am Anfang ein gro�er Buchstabe
	 */
	public void setName(String name) {
		// ruft die Methode 'entferneSonderzeichen' der eigenen Klasse auf mit dem
		// übergebenen Parameter und deklariert den String erlaubt mit dem
		// zurückgegebenen String
		String erlaubt = this.entferneSonderzeichen(name);
		// führt den ersten Block aus falls der String aus mindestens zwei Zeichen
		// besteht, ansonsten wird der Zweite Block ausgeführt
		if (erlaubt.length() > 1)
	...
	/**
	 * Setzt die als Parameter übergeben Groesse als neue groesse für das aktuelle
	 * Hund-Objekt. Falls der Parameter groesser 111 oder kleiner 10 ist, wird die
	 * groesse auf die entsprechende Grenzen gesetzt
	 * 
	...
	/**
	 * Setzt das als Parameter übergeben Gewicht als neues gewicht für das
	 * aktuelle Hund-Objekt. Falls der Parameter groesser 143 oder kleiner 0.5 ist,
	 * wird das gewicht auf die entsprechende Grenzen gesetzt Hunde wiegen
	 * mindestens 500g und maximal 143kg
	 * 
	 * @param gewicht
	 */
	...
	/**
	 * Setzt die Rasse des Hundes auf den übergebenen Parameter falls die Rasse aus
	 * mehr als vier Sonderzeichen besteht
	 * 
	 * @param rasse
	 */
	public void setRasse(String rasse) {
		...
		// führt den ersten Block aus falls der String aus mindestens fünf Zeichen
		// besteht, ansonsten wird der Zweite Block ausgeführt
		if (erlaubt.length() > 4)
	...
	/**
	 * Gibt eine Reihe von Strings auf der Konsole aus die das aktuelle Hund-Objekt
	 * repräsentieren
	 */
	public void ausgabe() {
		// gibt auf der Konsole den eingefügten String aus
