...
public class Kfz {
	...
	public void setGewicht(int gewicht) throws InputMismatchException {
		if (gewicht < 60) {
			throw new InputMismatchException(
					"ung�ltiges Gewicht eingegeben, das Gewicht darf nicht kleiner als 60 kg sein");
		} else if (gewicht > 10000) {
			throw new InputMismatchException(
					"ung�ltiges Gewicht eingegeben, das Gewicht darf nicht groesser als 10000 kg sein");
		} else {
	...
	public void setMarke(String marke) throws InputMismatchException {
		...
		if (erlaubt.length() < 2) {
			throw new InputMismatchException("Keine g�ltige Marke eingegeben, bitte noch einmal versuchen.");
		} else {
			this.marke = marke;
		}
	}
	...
	public void setModelle(String modelle) {
		...
		if (erlaubt.length() < 5) {
			throw new InputMismatchException("Keine g�ltiges Modell eingegeben, bitte noch einmal versuchen.");
		} else {
	...
	public void setBreite(int breite) throws InputMismatchException {
		...
		if (breite < 991) {
			throw new InputMismatchException(
					"ung�ltige Breite eingegeben, die Breite darf nicht kleiner als 991 mm sein");
		} else if (breite > 2191) {
			throw new InputMismatchException(
					"ung�ltige Breite eingegeben, die Breite darf nicht groesser als 2191 mm sein");
		} else {
			this.breite = breite;
		}
	}
	...
	public void setLaenge(int laenge) {
		if (breite < 1321) {
			throw new InputMismatchException(
					"ung�ltige Laenge eingegeben, die Breite darf nicht kleiner als 1321 mm sein");
		} else if (breite > 6092) {
			throw new InputMismatchException(
					"ung�ltige Laenge eingegeben, die Breite darf nicht groesser als 6092 mm sein");
		} else {
			this.laenge = laenge;
		}
	}
	...
	public void setHoehe(int hoehe) {
		if (breite < 1003) {
			throw new InputMismatchException(
					"ung�ltige Hoehe eingegeben, die Hoehe darf nicht kleiner als 1003 mm sein");
		} else if (breite > 2006) {
			throw new InputMismatchException(
					"ung�ltige Hoehe eingegeben, die Hoehe darf nicht groesser als 2006 mm sein");
		} else {
			this.hoehe = hoehe;
		}
	}
	...
	public void setName(String name) {
		...
		if (erlaubt.length() < 1) {
			throw new InputMismatchException("Keine g�ltigen Namen eingegeben, bitte noch einmal versuchen.");
		} else {
			this.name = name;
		}
	}
